...
+ (instancetype)modelWithDic:(NSDictionary *)dic {
    ...
    foldCellModel.text = dic[@"name"];
    foldCellModel.level = dic[@"rank"];
    foldCellModel.proCategoryId = dic[@"id"];
    foldCellModel.belowCount = 0;
    if ([[dic allKeys] containsObject:@"children"]&&!([dic[@"children"] isEqual:[NSNull null]])) {
        foldCellModel.submodels = [NSMutableArray new];
        NSArray *submodels = dic[@"children"];
